            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-6 col-lg-7">
                    <div class="mb-3">
                        ...
                        <input type="date" id="date" name="date" class="form-control" value="{{ $reservation->date }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="time" class="form-label fw-semibold">Time</label>
                        <input type="time" id="time" name="time" class="form-control" value="{{ $reservation->time }}" readonly>
                    </div>
                    <div>
                        <label for="contact" class="form-label fw-semibold">Contact</label>
                        <input type="text" id="contact" name="contact" class="form-control" value="{{ $reservation->contact }}" placeholder="Phone or email" readonly>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control my-1" name="note" id="note" style="resize: none; overflow: hidden" placeholder="No Notes." readonly>{{ $reservation->note }}</textarea>
                </div>
