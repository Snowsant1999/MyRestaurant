            ...
            <div class="card shadow-sm p-4" style="max-width: 400px; width: 100%; max-height: auto; height: 100%; border-radius: 15px;">
                ...
                <form action="{{route('registerUser')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Insert Your Username" value="{{ old('name') }}" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Email</label>
                        <input type="email" class="form-control" name="email" placeholder="Insert Your Email" value="{{ old('email') }}" required>
                    </div>
                    <div class="mb-4">
